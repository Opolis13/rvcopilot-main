...
fun ListTripsScreen(
    ...
    println("on ListTripsScreen")

    LaunchedEffect(currentUser.username) {
        viewModel.loadTrips(currentUser.username)
    }
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                Button(
                    onClick = { viewModel.navigateToCreateTrip() },
                    modifier = Modifier
                        .fillMaxWidth()
                        //.width(200.dp)
                        .height(60.dp)
            ...
            items(trips) { trip ->
                Row(
                    ...
                    println("Loading Trip: ${trip.destination}, image ID: ${trip.imageName}")
                    ...
                    println("ListTripsScreen: resId: $resId")
                    Image(
